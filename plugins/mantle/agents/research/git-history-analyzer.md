...
Note that files in `docs/plans/` and `docs/solutions/` are mantle pipeline artifacts created by `/mantle:plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
