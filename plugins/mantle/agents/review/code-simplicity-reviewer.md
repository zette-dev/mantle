...
5. **Apply YAGNI Rigorously**:
   ...
   - Never flag `docs/plans/*.md` or `docs/solutions/*.md` for removal — these are mantle pipeline artifacts created by `/mantle:plan` and used as living documents by `/mantle:work`
