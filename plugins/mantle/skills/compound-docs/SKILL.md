...
4. Add to existing skill - Add to a learning skill (e.g., project-conventions)
...
Action:
1. Prompt: "Which skill? (project-conventions, etc.)"
...
Example: For a project-specific styling solution:
- project-conventions = some framework, language, soltution used in the repo (flutter, go, fastapi, terraform, etc)
- Add to `{project-conventions}/references/resources.md` under "Project-Specific Resources"
- Add to `{project-conventions}/references/examples.md` with link to solution doc
