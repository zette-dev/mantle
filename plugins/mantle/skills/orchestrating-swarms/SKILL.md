...
From the `mantle` plugin (examples):

### Review Agents
```javascript
// Security review
Task({
  subagent_type: "mantle:review:security-sentinel",
...
// Performance review
Task({
  subagent_type: "mantle:review:performance-oracle",
...
// Architecture review
Task({
  subagent_type: "mantle:review:architecture-strategist",
...
// Code simplicity
Task({
  subagent_type: "mantle:review:code-simplicity-reviewer",
  description: "Simplicity check",
  prompt: "Check if this implementation can be simplified"
})
```

**All review agents from mantle:**
...
Task({
  subagent_type: "mantle:research:best-practices-researcher",
...
Task({
  subagent_type: "mantle:research:framework-docs-researcher",
...
Task({
  subagent_type: "mantle:research:git-history-analyzer",
...
```javascript
Task({
  subagent_type: "mantle:design:figma-design-sync",
...
prompt: `
  ...
  2. Check all database queries have proper eager loading
